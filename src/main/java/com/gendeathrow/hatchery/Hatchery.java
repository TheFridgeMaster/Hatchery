...
public class Hatchery {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        for (Biome allBiomes : ForgeRegistries.BIOMES.getValues())
            if (!BiomeDictionary.isBiomeOfType(allBiomes, Type.WASTELAND)
                    && !BiomeDictionary.isBiomeOfType(allBiomes, Type.COLD)
                    && !BiomeDictionary.isBiomeOfType(allBiomes, Type.NETHER)
                    && !BiomeDictionary.isBiomeOfType(allBiomes, Type.END)
                    && !BiomeDictionary.isBiomeOfType(allBiomes, Type.WATER)
                    && !BiomeDictionary.isBiomeOfType(allBiomes, Type.SWAMP))
